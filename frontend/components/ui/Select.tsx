    ...
    return (
      <div className="space-y-2">
        ...
        <div className="relative">
          <select
            className={cn(
              "w-full bg-card/80 border border-primary/20 rounded-2xl px-3 py-2 text-foreground text-sm backdrop-blur-sm hover:border-primary/40 focus:border-primary/60 focus:ring-2 focus:ring-ring/20 transition-all duration-200 appearance-none cursor-pointer pr-10",
